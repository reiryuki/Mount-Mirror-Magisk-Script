...
Install this script https://devuploads.com/d2nj0bzirtd3 via Magisk app or KernelSU app or Kitsune Mask app or Apatch app only. (Does not require reboot. Rebooting will remove mirrors automatically).
